...
public class PerpetualCalendarParser {
    ...
    public static PerpetualCalendar getGson(StringBuffer result) {
        ...
        try {
            ...
            p = new PerpetualCalendar(js1.getString("animalsYear"), js1.getString("weekday"), js1.getString("lunar"), js1.getString("lunarYear"),
                    js1.getString("year-month"), js1.getString("date"),js1.getString("avoid"),js1.getString("suit"),null);
